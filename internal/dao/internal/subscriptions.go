...
// SubscriptionsColumns defines and stores column names for the table subscriptions.
...
// subscriptionsColumns holds the columns for the table subscriptions.
...
func NewSubscriptionsDao(handlers ...gdb.ModelHandler) *SubscriptionsDao {
